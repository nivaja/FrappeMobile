...
class Geolocation extends StatefulWidget {
  ...
  const Geolocation({Key? key, required this.doctypeField, this.doc})
      : super(key: key);
...
class _GeolocationState extends State<Geolocation> with ControlInput {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
        height: 500,
        width: 500,
        child: widget.doc?[widget.doctypeField.fieldname] == null
            ? FormBuilderMapField(
  ...
  Widget _loadMap() {
    Map<String, dynamic> geoMap =
        json.decode(widget.doc![widget.doctypeField.fieldname])
      ...
      children: [
        ...
        FrappeFlatButton(
            onPressed: () async {
              await launchUrl(
                Uri.parse(
                    'https://www.google.com/maps/dir//${geoCoords[1]},${geoCoords[0]}'),
